...
import UseAddListing from "../hooks/listing/UseAddListing";
        ...
        <div className="bg-darkWhite relative text-gray grid font-bold px-16 py-5   text-left rounded-2xl space-y-4 w-2/6">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-1 grid">
              <textarea
                className="w-full border outline-none font-normal  p-2 rounded resize-none cursor-default"
                rows={8}
                onChange={(e) =>
                  setForm((prev) => ({
                    ...prev,
          ...
          <div className="space-y-1  grid">
            ...
            <input
              ...
              className="p-2 font-normal outline-none cursor-default text-black border "
            ...
            <div className="grid gap-4 grid-cols-2">
              ...
              <div className="col-span-2 ml-4 grid-cols-2 gap-4 grid">
                ...
                <textarea
                  ...
                  className="p-2 font-normal cursor-default resize-none outline-none col-span-2 text-black border"
                />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-1 grid-cols-2 grid gap-5">
            <div className="grid ">
              ...
              <input
                ...
                step={1}
                className="border-2 px-3 py-2 cursor-default font-normal rounded "
            ...
            <div className=" grid">
              ...
              <input
                ...
                className="border-2 px-3 py-2 cursor-default font-normal rounded w-full"
                placeholder="0"
              />
            </div>
          </div>
